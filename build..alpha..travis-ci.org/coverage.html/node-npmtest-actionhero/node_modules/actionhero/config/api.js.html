...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-actionhero/node_modules/actionhero/config/api.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-actionhero/node_modules/actionhero/config/api.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-actionhero/node_modules/actionhero/config/</a> &#187; api.js</div>
</div>
<div class="body">
...
93
94
95</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
exports['default'] = {
  general: <span class="fstat-no" title="function not covered" >function (api) {</span>
<span class="cstat-no" title="statement not covered" >    const packageJSON = require(api.projectRoot + path.sep + 'package.json')</span>
&nbsp;
